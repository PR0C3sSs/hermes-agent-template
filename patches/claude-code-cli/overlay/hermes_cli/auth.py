...
DEFAULT_CLAUDE_CODE_CLI_BASE_URL = "claude-code-cli://claude"
...
def resolve_provider(
    ...
    *,
    ...
    _PROVIDER_ALIASES = {
        ...
        "claude-cli": "claude-code-cli", "claude-code-cli": "claude-code-cli",
    ...
    if provider_id == "claude-code-cli":
        ...
        if not resolved_command:
            raise AuthError(
                ...
                "or set HERMES_CLAUDE_CODE_COMMAND/CLAUDE_CODE_CLI_PATH.",
                provider=provider_id,
